...
$app->post("/profile/change-password", function(){
    ...
    if(!isset($_POST['current_pass']) || $_POST['current_pass'] === '') { //confere se ele digitou a senha atual
    	User::setError("Digite a senha atual");
    	header("Location: /profile/change-password");
    	exit;
    }

    if(!isset($_POST['new_pass']) || $_POST['new_pass'] === '') { //confere se ele digitou a senha atual
    	User::setError("Digite a nova senha");
    	header("Location: /profile/change-password");
    	exit;
    }

    if(!isset($_POST['new_pass_confirm']) || $_POST['new_pass_confirm'] === '') { //confere se ele digitou a senha atual
    	User::setError("confirme a nova senha");
    	header("Location: /profile/change-password");
    	exit;
    }

    //a senha nova é igual a senha atual ?
    ...
    }//verifica se a senha atual digitada é a mesma que esta no banco
